            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="upload-container">
                        ...
                        <!-- 폼 액션: /post/create 또는 /story/create로 동적 할당 -->
                            ...
                            <div class="card card-upload shadow-sm ${name eq 'story' ? 'theme-story' : 'theme-post'}">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-grid gap-2">
                                        <button type="submit" class="btn btn-block ${name eq 'story' ? 'btn-danger' : 'btn-primary'} btn-user">
